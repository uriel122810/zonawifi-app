# 2026-08-05 18:27:52 by RouterOS 7.18.2
...
add bridge=bridge1 hw=no interface=LAN internal-path-cost=10 path-cost=10
add bridge=bridge1 hw=no interface=ANTENA internal-path-cost=10 path-cost=10
